#!/bin/bash
#SBATCH --job-name=fineweb_tinyllama_5e-6_128
...
#SBATCH --exclude=babel-4-[1,17,25,33,37]
...
# data_path="/data/user_data/jingyuah/LLARA/data/pretrain/${dataset}_item_96k.jsonl" # toy_pretrain_data.jsonl # 981k items

dataset="fineweb"
data_path="/data/datasets/hf_cache/sample/10BT"

expt_name="${dataset}_tinyllama_1b_EBAE_5e-6"
...
NCCL_P2P_DISABLE=1 torchrun --nproc_per_node $n_gpus --master_port=12345 --rdzv_endpoint=localhost:29408 \
    run.py \
